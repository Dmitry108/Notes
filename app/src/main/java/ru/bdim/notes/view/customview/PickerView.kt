...
import ru.bdim.notes.model.getColorRes
import ru.bdim.notes.model.takeColor


class PickerView : LinearLayout {
    ...
    var onColorClickListener: (color: Note.NoteColor) -> Unit = { }
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) :
        ...
        Note.NoteColor.values().forEach { color ->
            addView(
                ColorView(context).apply {
                    ...
                    setOnClickListener { onColorClickListener(it.tag as Note.NoteColor) }
                })
        }
